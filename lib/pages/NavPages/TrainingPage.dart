                  ...
                  child: Column(
                   ...
                   /*   TextField(
                      ...
                      Row(
                        ...
                        children: [
                          Text("Yoga By Type", style: TextStyle(
                              fontSize: 18, fontWeight: FontWeight.bold),),
                          TextButton(onPressed: () {},
                            child: Text(
                              "Explore", style: TextStyle(fontSize: 12),)
                            ,),
                        ],
                      ),
                      ...
                      Row(
                        mainAxisAlignment: MainAxisAlignment.spaceBetween,
                        children: [
                          Text("Yoga By Anatomy ", style: TextStyle(
                              fontSize: 18, fontWeight: FontWeight.bold),),
                          TextButton(onPressed: () {},
                            child: Text(
                              "Explore", style: TextStyle(fontSize: 12),)
                      ...
                      Row(
                        mainAxisAlignment: MainAxisAlignment.spaceBetween,
                        children: [
                          Text("Yoga By Benefits ", style: TextStyle(
                              fontSize: 18, fontWeight: FontWeight.bold),),
                          TextButton(onPressed: () {},
                            child: Text(
                              "Explore", style: TextStyle(fontSize: 12),)
